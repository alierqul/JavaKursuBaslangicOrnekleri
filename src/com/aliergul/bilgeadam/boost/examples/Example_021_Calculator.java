...
import com.aliergul.bilgeadam.boost.util.MyStringHelper;
...
public class Example_021_Calculator {
	...
	private static void sayHarfIslemi() {
		...
		System.out.printf("\n\t\t= %s Harfi Sayısı        : %d \n", chr,
				MyStringHelper.sayHarf(msg, String.valueOf(chr)));
	...
	private static void reverseString() {
		...
		System.out.print("\n\t\t= Metin Tersi         : " + MyStringHelper.reverseString(str));
	...
	private static void soruDokuzCozum() {
		...
		newStr = MyStringHelper.reverseString(msg);
		System.out.print("\n\t\t 1) Tersi: " + newStr);
		newStr = MyStringHelper.silTekSayiHarfMetin(newStr);
		System.out.println("\n\t\t 2) TekSayilar sil: " + newStr);
		System.out.println("\n\t\t 3)  Bulunan e sayısı: " + MyStringHelper.sayHarf(newStr, "e"));
		newStr = MyStringHelper.cikarHarf(newStr, "e");
